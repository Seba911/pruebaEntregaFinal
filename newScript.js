...
/* function clickearOpcionA(status, arrOpcionA){
    if (status == arrOpcionA ) {
        alert("Siguiente pregunta")
    } else {
        alert("Entraste a los errores")
        console.log("Por que!!")
    }
} */
/* function clickearOpcionB(status, arrOpcionB){
    if (arrOpcionB === status) {
        alert("Siguiente pregunta")
    } else {
        alert("Entraste a los errores")
    }
} */
/* function clickearOpcionC(status, arrOpcionC){
    if (arrOpcionC === status) {
        alert("Siguiente pregunta")
    } else {
        alert("Entraste a los errores")
    }
} */
/* function clickearOpcionD(status, arrOpcionD){
    if (arrOpcionD === status) {
        alert("Siguiente pregunta")
    } else {
        alert("Entraste a los errores")
    }
    ...
    // Pregunta 1 Apellido
    {
        ...
        opciones:
            [
                ...
                { text: "FLIMPSON", correct: false },
                { text: "PATIÑO", correct: false },
            ],
...
/* REVER ESTO DE LOS BOTONES Y EVENTOS */
/* let getBoton_opcionA_InHTML = document.getElementById("botonOpcionA")
let getBoton_opcionB_InHTML = document.getElementById("botonOpcionB")
let getBoton_opcionC_InHTML = document.getElementById("botonOpcionC")
let getBoton_opcionD_InHTML = document.getElementById("botonOpcionD")

getBoton_opcionA_InHTML.addEventListener("click", clickearOpcionA)
getBoton_opcionB_InHTML.addEventListener("click", clickearOpcionB)
getBoton_opcionC_InHTML.addEventListener("click", clickearOpcionC)
getBoton_opcionD_InHTML.addEventListener("click", clickearOpcionD) */
...
if (personaje === "a" || personaje === "A" || personaje === ArrPreguntasHomero[0].nombre) {
    ...
    // REVER ESTO
    /*     clickearOpcionA(true, ArrPreguntasHomero[0].op_A_apellidoCorrecta)
        clickearOpcionB(false, ArrPreguntasHomero[0].op_B_apellido )
        clickearOpcionC(false, ArrPreguntasHomero[0].op_C_apellido )
        clickearOpcionD(false, ArrPreguntasHomero[0].op_D_apellido ) */
